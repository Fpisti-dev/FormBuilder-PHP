        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <fieldset>
                    ...
                    <div class="input-group col-sm-12">
                        <label class="control-label col-sm-5 modal-label" for="txtEditorName">Last editor</label>
                        <div class="input-group col-sm-7">
                            <input id="txtEditorName" name="txtEditorName" type="text" class="form-control"/>
                        </div>                
                    </div>
                    <div class="input-group col-sm-12">
